export default [
  ...
  { name: 'Central African Republic', alpha3: 'CAF', countryCode: '140' },
  ...
  { name: 'Cocos (Keeling) Islands', alpha3: 'CCK', countryCode: '166' },
  ...
  { name: 'Netherlands', alpha3: 'NLD', countryCode: '528' },
  ...
  { name: 'Northern Mariana Islands', alpha3: 'MNP', countryCode: '580' },
  ...
  { name: 'Turkey', alpha3: 'TUR', countryCode: '792' },
  { name: 'Turkmenistan', alpha3: 'TKM', countryCode: '795' },
  { name: 'Turks and Caicos Islands', alpha3: 'TCA', countryCode: '796' },
  ...
  { name: 'United States of America', alpha3: 'USA', countryCode: '840' },
  {
  ...
  { name: 'Virgin Islands (British)', alpha3: 'VGB', countryCode: '092' },
